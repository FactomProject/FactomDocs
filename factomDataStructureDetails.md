...
A Directory Block consists of a header and a body. The body is a series of pairs of ChainIDs and Entry Block Merkle Roots.  The Body and BodyMR are derived from iterating the iterating the process lists generated by the Federated servers over the last 10 minutes.
...
| **Body** |  |  |
| variable | All objects | A series of variable sized objects and timestamps arranged in chronological order.  Each object is prepended with an AdminID byte. |
