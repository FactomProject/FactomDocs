...
Here are the binaries for [Windows](http://factom.org/downloads/factom.exe.zip), [Mac](http://factom.org/downloads/factom.mpkg.zip), and [Linux](http://factom.org/downloads/factom.deb).
